...
export interface ApiRoomRoom extends Schema.CollectionType {
  ...
  attributes: {
    room_name: Attribute.String & Attribute.Required & Attribute.Unique;
...
export interface ApiStudentStudent extends Schema.CollectionType {
  ...
  attributes: {
    student_id: Attribute.BigInteger & Attribute.Required & Attribute.Unique;
    name: Attribute.String & Attribute.Required & Attribute.Unique;
    last_name: Attribute.String & Attribute.Required & Attribute.Unique;
    year: Attribute.Integer & Attribute.Required;
    student_image: Attribute.Media & Attribute.Required;
    mapping: Attribute.Relation<
      'api::student.student',
      'manyToOne',
      'api::mapping.mapping'
...
export interface ApiSubjectSubject extends Schema.CollectionType {
  ...
  attributes: {
    subject_id: Attribute.BigInteger & Attribute.Required & Attribute.Unique;
    subject_name: Attribute.String & Attribute.Required & Attribute.Unique;
    subject_type: Attribute.Enumeration<
...
export interface ApiTeacherTeacher extends Schema.CollectionType {
  ...
  attributes: {
    ...
    teacher_email: Attribute.Email & Attribute.Required & Attribute.Unique;
    teacher_image: Attribute.Media & Attribute.Required;
    mapping: Attribute.Relation<
      'api::teacher.teacher',
      'manyToOne',
      'api::mapping.mapping'
